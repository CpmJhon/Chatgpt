      ...
      document.addEventListener('DOMContentLoaded', function () {
          var telegramDiv = document.querySelector('.Website');
          telegramDiv.addEventListener('click', function () {
              window.open('https://website-jhon.fariddewangga.repl.co/', '_blank');
          });
      });
      document.addEventListener('DOMContentLoaded', function () {
          var telegramDiv = document.querySelector('.Instagram');
          telegramDiv.addEventListener('click', function () {
              window.open('https://instagram.com/cpm_jhon?igshid=MTNuMnE3aXlxcGxx', '_blank');
          });
      });
      document.addEventListener('DOMContentLoaded', function () {
          var telegramDiv = document.querySelector('.Tiktok');
          telegramDiv.addEventListener('click', function () {
              window.open('https://tiktok.com/@garasidriftcpm', '_blank');
          });
      });
      document.addEventListener('DOMContentLoaded', function () {
          var telegramDiv = document.querySelector('.Youtube');
          telegramDiv.addEventListener('click', function () {
              window.open('https://youtube.com/@galeri_car_cpm8048?si=eyGUcAitv0GWqGVe', '_blank');
          });
      });
      document.addEventListener('DOMContentLoaded', function () {
          var telegramDiv = document.querySelector('.whatsapp');
          telegramDiv.addEventListener('click', function () {
              window.open('https://wa.me/6285894955362', '_blank');
          });
      });
      ...
      document.addEventListener('DOMContentLoaded', function () {
          ...
          var audio = new Audio('./TienMinhMusic.mp3');
      ...
      welcomeText.textContent = "Designed By CPM_JHON =))";
